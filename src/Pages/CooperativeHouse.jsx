...
const CooperativeHousingSocietyManagementPage = () => {
  ...
  return (
    <>
      <HeadProvider>
        <Title>Cooperative Housing Society Management | Azalea Services</Title>
        <Meta
          name="description"
        ...
        <section className="bg-[#f2e9df] text-green-900 px-6 py-10 md:py-20 animate-fadeIn">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 mt-2 text-base max-w-2xl mx-auto italic">
              Our specialized services support cooperative housing societies
              with comprehensive management of finances, infrastructure,
              security, and community activities for transparent and efficient
              operations.
            </p>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  description:
                    "Elect management committee including president, secretary, and treasurer",
                },
                {
                  step: "02",
                  title: "Planning & Budgeting",
                  description:
                    "Prepare annual programs, budgets, and activity schedules",
                },
                {
                  step: "03",
                  title: "Operations Management",
                  description:
                    "Handle daily finances, maintenance, and resident services",
                },
                {
                  step: "04",
                  title: "Review & Reporting",
                  description:
                    "Conduct audits, meetings, and provide updates to members",
                },
              ].map((step, index) => (
                <div
                  key={index}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mt-2 text-base max-w-2xl mx-auto">
                Enjoy affordability, security, and community harmony through
        ...
        <section className="bg-[#f2e9df] text-green-900 px-6 py-10 md:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 mt-2 text-base max-w-2xl mx-auto mb-12">
              Utilize modern software for seamless society operations and
              resident engagement.
            </p>
        ...
        <section className="bg-green-900 text-white px-6 py-10 md:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Ready to streamline your cooperative housing society management?
              Schedule a free consultation with our experts and discover
              tailored solutions for efficient operations and resident
              satisfaction.
            </p>
            <a
              onClick={toggleOpen}
